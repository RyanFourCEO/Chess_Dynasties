//identical to the TextButtonClass, except the Label object is a LabelWithShader object instead,
//which extends the label class and uses a distance field shader when drawing text
/*******************************************************************************
...
public class TextButton2 extends Button {
    ...
    public TextButton2(String text, TextButtonStyle style) {
        ...
        setStyle(style);
        this.style = style;
        label = new LabelWithShader(text, new LabelStyle(style.font, style.fontColor));
